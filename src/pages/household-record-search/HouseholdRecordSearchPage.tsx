  ...
  return (
    <>
      ...
      <main className="min-h-0 flex-grow overflow-auto bg-bg-gray pt-[48px]">
        <HouseholdRecordsPanel filters={filters} householdId={householdId} isCompactGrouped showSummary={false} />
      </main>
      <Popup destroyOnClose position="bottom" showCloseButton visible={isFiltersVisible} onClose={() => setIsFiltersVisible(false)}>
        <form className="max-h-[75vh] overflow-auto bg-white px-3 pb-4 pt-10" data-testid="household-record-filters" onSubmit={handleSubmit}>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <Button block onClick={handleReset}>{t('records.reset')}</Button>
