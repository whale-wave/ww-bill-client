...
export const BudgetPresentation: React.FC<BudgetPresentationProps> = ({
  ...
  return (
    <div className="relative flex min-h-0 flex-grow flex-col overflow-hidden">
      <div className="min-h-0 flex-grow overflow-y-auto overscroll-contain px-[18px] pb-5 pt-1" data-budget-scroll-container ref={scrollContainerRef}>
        <BudgetItem
          budgetEntityType={budgetEntityType}
          data={summary}
          editable={!readOnly}
      ...
      {!readOnly && (
        <div className="z-10 shrink-0 border-0 border-t border-solid border-white/60 bg-[#f7f5f8]/90 px-[18px] pb-[calc(12px+env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl">
          <button
