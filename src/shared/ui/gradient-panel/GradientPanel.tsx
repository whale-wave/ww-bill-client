...
const toneClassNames: Record<GradientPanelTone, string> = {
  blue: 'bg-gradient-to-br from-white/90 via-[#e5f7fc]/90 to-[#c8eaf6]/80',
  pink: 'bg-gradient-to-br from-white/90 via-[#fff1f6]/90 to-[#ffd8e6]/75',
  purple: 'bg-gradient-to-br from-white/90 via-[#f4efff]/90 to-[#e2d9ff]/75',
  white: 'bg-white/85',
};
...
const surfaceClassNames: Record<GradientPanelSurface, string> = {
  ...
  glass: 'border-border-primary bg-white/[0.84]',
...
export function GradientPanel({
  ...
  return (
    <Component
      className={`rounded-[20px] border backdrop-blur-xl ${elevationClassNames[elevation]} ${surface ? surfaceClassNames[surface] : `border-border-primary ${toneClassNames[tone]}`} ${className}`}
      {...props}
    >
      {children}
    </Component>
