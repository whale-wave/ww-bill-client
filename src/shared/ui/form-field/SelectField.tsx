...
export function SelectField({ className, disabled, label, onChange, options, placeholder, value }: SelectFieldProps) {
  ...
  return (
    <label className={cn('block min-w-0', className)} htmlFor={selectId}>
      ...
      <span className="relative block">
        ...
        <ChevronDown aria-hidden="true" className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-ww-soft" size={18} />
      </span>
    </label>
  );
}
